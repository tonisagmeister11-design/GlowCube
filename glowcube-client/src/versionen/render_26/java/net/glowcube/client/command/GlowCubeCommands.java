...
public final class GlowCubeCommands {
    ...
    public static void registrieren() {
        ClientCommandRegistrationCallback.EVENT.register((zweig, zugriff) -> {
            ...
            zweig.register(ClientCommands.literal("agentort")
                    .executes(kontext -> {
                    ...
                    .then(ClientCommands.literal("weg").executes(kontext -> {
            ...
            zweig.register(ClientCommands.literal("agentkiste")
                    .executes(kontext -> {
            ...
            zweig.register(ClientCommands.literal("panic").executes(kontext -> {
