...
/**
 * Fassung fuer <b>26.3 und neuer</b> des ClickGUI. Bis auf den neuen 2D-Typ
 * ({@code GuiGraphicsExtractor} statt {@code GuiGraphics}) und den
 * versionssicheren Bildschirmwechsel ({@link net.glowcube.client.render.Netz})
 * wortgleich zur 1.21-Fassung: die Input-Ereignisse ({@code MouseButtonEvent},
 * {@code KeyEvent}, {@code CharacterEvent}) sind auf 26.3 dieselben.
 *
 * <p>Bedienung wie gehabt: Links schaltet, Rechts oeffnet die Einstellungen,
 * Mitte belegt die Taste, die Titelleiste zieht das Fenster, Tippen sucht.
 */
public final class ClickGuiScreen extends Screen {
    ...
    private void fusszeile(GuiGraphicsExtractor gfx) {
    ...
    private void fensterZeichnen(GuiGraphicsExtractor gfx, Fenster fenster, int mouseX, int mouseY) {
    ...
    private float modulZeichnen(GuiGraphicsExtractor gfx, Fenster fenster, Module module,
    ...
    private float einstellungZeichnen(GuiGraphicsExtractor gfx, Fenster fenster, Module module,
    ...
    private void sucheZeichnen(GuiGraphicsExtractor gfx, int mouseX, int mouseY) {
        ...
        switch (t.art()) {
            ...
            case LISTE -> {
                if (t.setting() instanceof BlockListSetting liste) {
                    net.glowcube.client.render.Netz.bildschirmSetzen(new BlockListScreen(this, liste));
                } else if (t.setting() instanceof TextListSetting liste) {
                    net.glowcube.client.render.Netz.bildschirmSetzen(new TextListScreen(this, liste));
                }
                return true;
            }
            case WAHL_HACKS -> {
