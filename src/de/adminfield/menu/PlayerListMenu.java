...
import de.adminfield.menu.OfflinePlayerMenu;
...
extends Menu {
    ...
    protected void draw() {
        ...
        int offlineCount = OfflineStore.instance() == null ? 0 : OfflineStore.instance().all().size();
        this.set(46, Ui.icon(Material.ENDER_CHEST, "<gold>Offline-Spieler", List.of("<gray>Spieler, die gerade nicht da sind.", "", "<gray>Inventar und Enderkiste lassen sich", "<gray>trotzdem bearbeiten.", "", "<gray>Bekannt: <white>" + offlineCount, "<yellow>➤ Klicken zum Öffnen")), inventoryClickEvent -> new OfflinePlayerMenu(this.plugin, this).open(this.viewer));
        this.closeButton(53);
        int n = this.page * 45;
